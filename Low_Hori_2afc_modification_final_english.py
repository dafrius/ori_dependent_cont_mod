# -*- coding: utf-8 -*-
"""
Created on Fri Sep 30 16:10:35 2022
...
def intofrench(input_dictionary,language): 
    instruction_dictionary_frenchy={} # made for french word initially but doesn't matter in the end
    for k,phrase in input_dictionary.items():
        translater = ts.google(phrase, from_language='en', to_language=language)
        instruction_dictionary_frenchy[k] = translater
    return instruction_dictionary_frenchy
...
instruction_dictionary={'instructions.text1': 'In this experiment, you will see a small patch of horizontal bars located in one of two possible spots inside a bigger circle of bars, or isolated, without any context.\n\n Your task is to locate where it appears on each trial, and to respond by pressing a key on your keyboard. If the horizontal bars appear:\n\n',
                         'instructions.text2': 'On the left \nPress Left Arrow ',
                         'instructions.text3': 'On the right \nPress Right Arrow',
                         'instructions.text4': 'After you respond, you will see a brief feedback about your accuracy.\nIn total, the experiment is expected to last ~45 minutes\n(9 blocks, 80 trials each).\nFeel free to take a short break inbetween blocks.\nPress SPACE key for the next instruction.',
                         'instructions.text5': 'Now you will do a short practice.\nBefore you begin, please make sure that your head is positioned\nso that the cross at the center of this screen aligns with your eyes.',
                         'instructions.text6': 'Please keep your gaze at the center at all times.\nPress SPACE key to begin the practice.',
                         'instructions.text7': 'Well done!\nEnd of practice.\nPress SPACE key to start the experiment.\nBlock:0/9',
                         'intblocktext.text':'Please take a rest until before the next block. You can press "SPACE" to start again after 30 seconds when you are ready.\nBlock: ',
                         'endtext.text':'Thank you for participating.\nPress a key to exit the experiment'}       
                         

# Now we translate the instruction if required
if exp_info['language']!='en':
    language = exp_info['language']
    instruction_dictionary=intofrench(instruction_dictionary, language)   
...
grating_hpos = [-5, 5] # laterality (0 = center)
